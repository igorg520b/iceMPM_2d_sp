...
#define CHECK_HDF(fct)                                                                             \
  if (fct < 0)                                                                                     \
  throw std::runtime_error("HDF5 error in vtkFLUENTCFFCustomReader: " + std::string(__func__) + " at " + \
    std::to_string(__LINE__))

VTK_ABI_NAMESPACE_BEGIN
vtkStandardNewMacro(vtkFLUENTCFFCustomReader);

//------------------------------------------------------------------------------
struct vtkFLUENTCFFCustomReader::vtkInternals
{
...
//------------------------------------------------------------------------------
vtkFLUENTCFFCustomReader::vtkFLUENTCFFCustomReader()
  : HDFImpl(new vtkFLUENTCFFCustomReader::vtkInternals)
{
...
//------------------------------------------------------------------------------
vtkFLUENTCFFCustomReader::~vtkFLUENTCFFCustomReader() = default;

//------------------------------------------------------------------------------
int vtkFLUENTCFFCustomReader::RequestData(vtkInformation* vtkNotUsed(request),
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PrintSelf(ostream& os, vtkIndent indent)
{
...
//------------------------------------------------------------------------------
int vtkFLUENTCFFCustomReader::RequestInformation(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** vtkNotUsed(inputVector), vtkInformationVector* vtkNotUsed(outputVector))
{
  ...
  this->FileState = this->OpenDataFile(this->DataFileName);
  if (this->FileState == DataState::NOT_LOADED)
  {
...
//------------------------------------------------------------------------------
bool vtkFLUENTCFFCustomReader::OpenCaseFile(const std::string& filename)
{
...
//------------------------------------------------------------------------------
int vtkFLUENTCFFCustomReader::GetNumberOfCellArrays()
{
  return this->CellDataArraySelection->GetNumberOfArrays();
}

//------------------------------------------------------------------------------
const char* vtkFLUENTCFFCustomReader::GetCellArrayName(int index)
{
  return this->CellDataArraySelection->GetArrayName(index);
}

//------------------------------------------------------------------------------
int vtkFLUENTCFFCustomReader::GetCellArrayStatus(const char* name)
{
  return this->CellDataArraySelection->ArrayIsEnabled(name);
}

//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::SetCellArrayStatus(const char* name, int stat)
{
  if (stat)
  {
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::EnableAllCellArrays()
{
  this->CellDataArraySelection->EnableAllArrays();
}

//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::DisableAllCellArrays()
{
  this->CellDataArraySelection->DisableAllArrays();
}

//------------------------------------------------------------------------------
vtkFLUENTCFFCustomReader::DataState vtkFLUENTCFFCustomReader::OpenDataFile(const std::string& filename)
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetNumberOfCellZones()
{
  for (const auto& cell : this->Cells)
  {
...
//------------------------------------------------------------------------------
int vtkFLUENTCFFCustomReader::ParseCaseFile()
{
  try
  {
    this->GetNodesGlobal();
...
//------------------------------------------------------------------------------
int vtkFLUENTCFFCustomReader::GetDimension()
{
  hid_t group, attr;
  int32_t dimension;
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetNodesGlobal()
{
  hid_t group, attr;
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetNodes()
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetCellsGlobal()
{
  hid_t group, attr;
  uint64_t firstIndex, lastIndex;
  group = H5Gopen(this->HDFImpl->FluentCaseFile, "/meshes/1", H5P_DEFAULT);
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetCells()
{
  hid_t group, attr, dset;
  uint64_t nZones;
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetFacesGlobal()
{
  hid_t group, attr;
  uint64_t firstIndex, lastIndex;
  group = H5Gopen(this->HDFImpl->FluentCaseFile, "/meshes/1", H5P_DEFAULT);
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetFaces()
{
  hid_t group, attr, dset;
  uint64_t nZones;
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetPeriodicShadowFaces()
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetCellOverset()
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetCellTree()
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetFaceTree()
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetInterfaceFaceParents()
{
  herr_t s1 =
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::GetNonconformalGridInterfaceFaceInformation()
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::CleanCells()
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PopulateCellTree()
{
  for (const auto& cell : this->Cells)
  {
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PopulateCellNodes()
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PopulateTriangleCell(int i)
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PopulateTetraCell(int i)
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PopulateQuadCell(int i)
{
  this->Cells[i].nodes.resize(4);
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PopulateHexahedronCell(int i)
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PopulatePyramidCell(int i)
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PopulateWedgeCell(int i)
{
...
//------------------------------------------------------------------------------
void vtkFLUENTCFFCustomReader::PopulatePolyhedronCell(int i)
{
...
//------------------------------------------------------------------------------
int vtkFLUENTCFFCustomReader::GetData()
{
...
//------------------------------------------------------------------------------
int vtkFLUENTCFFCustomReader::GetMetaData()
{
  if (H5Gget_objinfo(this->HDFImpl->FluentDataFile, "/results/1", false, nullptr) == 0)
  {
    int iphase = 1;
